 ...
 */
class PrizeOrderIndex extends BaseContainer {
    searchData: any;
    //初始化加载
    constructor(props) {
        /*
   ...
   */
    ...
    exportOrder() {
        ...
        _this.props.form.validateFields(["ExportOrderName"], { force: true }, (errors, values) => {
            ...
            Tool.ExportCSVFile("/Order/ExportOrder?exportOrderName=" + encodeURIComponent(exportOrderName), { OrderType: 9 });
            _this.handleCancel();
        ...
        return (
            <AppBody>
                <div className="main-content-title padding-top15 clearfix">
                    <a className="main-content-word pull-left  set-content-word-te">奖品订单</a>
                </div>
...
let PrizeOrderIndexPage = Form.create({})(PrizeOrderIndex);

/**
 * 添加监听数据
 */
const App = connect(mapStateToProps)(PrizeOrderIndexPage);
