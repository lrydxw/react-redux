 ...
 */
class AllOrderIndex extends BaseContainer {
    searchData: any;
    //初始化加载
    constructor(props) {
        /*
        ...
        this.supplementOrderHandle = this.supplementOrderHandle.bind(this);
    ...
    searchDataList() {
        ...
        _this.state.OrderType = obj.OrderType;
    ...
    initOrderList() {
        ...
        obj.OrderType = _this.state.OrderType;
        ...
        setFieldsValue({ "SearchType": _this.state.SearchType, "OrderType": _this.state.OrderType });
    }
    ...
    exportOrder() {
        ...
        _this.props.form.validateFields(["ExportOrderName"], { force: true }, (errors, values) => {
            ...
            Tool.ExportCSVFile("/Order/ExportOrder?exportOrderName=" + encodeURIComponent(exportOrderName), { OrderType: 0 });
            _this.handleCancel();
    ...
    */
     ...
     * @param payOrderNo
     */
    supplementOrderHandle(payOrderNo) {
        var _this = this;
        var obj = { payOrderNo: payOrderNo };
        OrderApi.supplementOrderTask(obj).then(function (data) {
            if (data.IsOK) {
                _this.initOrderList();
            } else {
        ...
        const orderColumns = [
            {
                ...
                render: (text, record) => <div className="clearfix">
                    ...
                    <div className="pull-left col-xs-10">
                        ...
                        {record.PressieCount > 0 ? <p className="color-yellow padding0 margin0">
                            共计{record.PressieCount}件赠品
                        </p> : ""}
                    </div>
                </div>,
            },
            ...
            },
            {
                ...
                width: '8%',
                render: (text, record) => { if (record.OrderStatus == '待支付') { return (<span className="color-red"> {text.toFixed(2)}</span>) } else { return (<span> {text.toFixed(2)}</span>) } },
            },
            {
                title: '操作',
                key: 'operation',
                render: (text, record) => {
                    if (record.PayStatus == "支付成功") {
                        return (<span>
                            <Popconfirm title="确定要处理为正常订单吗？" onConfirm={() => { this.supplementOrderHandle(record.PayOrderNo) } }>
                                <a href="javascript:;">处理掉单</a>
                            </Popconfirm>
        ...
        return (
            <AppBody>
                <div className="main-content-title padding-top15 clearfix">
                    <a className="main-content-word pull-left  set-content-word-te">所有订单</a>
                </div>
                            ...
                            <Form horizontal>
                                <div className="row padding20">
                                    <div className=" margin-left15 clearfix">
                                        <p className="wechat-box-p5 pull-left">订单类型：</p>
                                        <div className="wechat-box-W5 pull-left">
                                            <FormItem>
                                                <Select allowClear={true} {...getFieldProps('OrderType') }>
                                                    <Option value="0">所有订单</Option>
                                                    <Option value="1">商品订单</Option>
                                                    <Option value="2">课程订单</Option>
                                                    <Option value="3">联合发起订单</Option>
                                                    <Option value="7">会员订单</Option>
                                                </Select>
                                            </FormItem>
                                        </div>
                                        <div className="wechat-box-W5 pull-left">
                                    ...
                                    <div className="margin-left15 clearfix">
                                        <div className="wechat-box-W7 pull-left">
                                            <FormItem>
                                    ...
                                    <div className="margin-left15 clearfix">
                                        <div className="wechat-bat pull-left">
                ...
                <Modal title="导出发货单" visible={this.state.visibleExportOrder} onCancel={this.handleCancel} footer={[]} >
...
let AllOrderIndexPage = Form.create({})(AllOrderIndex);

/**
 * 添加监听数据
 */
const App = connect(mapStateToProps)(AllOrderIndexPage);
