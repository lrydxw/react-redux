 ...
 */
class UserIntegralRankIndex extends BaseContainer {
    searchData: any;
    //初始化加载
    constructor(props) {
        /*
    ...
    initUserIntegralList() {
        ...
        AgencyManageApi.getMemberIntegralRankPageList(obj).then(function (data) {
            if (data.IsOK) {
                var functionData = [];
        ...
        return (
            <AppBody>
                <div className="main-content-title padding-top15 clearfix">
                    <a className="main-content-word pull-left  set-content-word-te">用户积分排行榜</a>
                </div>
...
let UserIntegralRankIndexPage = Form.create({})(UserIntegralRankIndex);

/**
 * 添加监听数据
 */
const App = connect(mapStateToProps)(UserIntegralRankIndexPage);
