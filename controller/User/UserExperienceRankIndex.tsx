 ...
 */
class UserExperienceRankIndex extends BaseContainer {
    searchData: any;
    //初始化加载
    constructor(props) {
        /*
    ...
    initUserIntegralList() {
        ...
        AgencyManageApi.getMemberExperienceRankPageList(obj).then(function (data) {
            if (data.IsOK) {
                var functionData = [];
        ...
        return (
            <AppBody>
                <div className="main-content-title padding-top15 clearfix">
                    <a className="main-content-word pull-left  set-content-word-te">用户经验值排行榜</a>
                </div>
...
let UserExperienceRankIndexPage = Form.create({})(UserExperienceRankIndex);

/**
 * 添加监听数据
 */
const App = connect(mapStateToProps)(UserExperienceRankIndexPage);
